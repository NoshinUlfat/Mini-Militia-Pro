...
public class ClientThread extends Thread {
    ...
    public void run() {
        try {
            ...
            System.out.println(" Client tread class saying I got "+clientName);
            ...
            while (true) {
                ...
                for (ClientThread clientConnected : clientsConnected) {
                    ...
                    if (clientConnected != null && !clientConnected.clientName.equals(this.clientName)) {
                        //do not send message to your self ;)
